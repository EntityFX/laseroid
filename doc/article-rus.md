...
В терминах игры уровень - волна (Wave), а несколько волн объеденены в большой уровень (Level), который представляет из себя просто смену заднего фона,
...
Оружие стреляет торпедами, алгоритм движения которых очень прмитивный: торпеды противника движутся на игрока (сверху вниз), а торпеды игрока движутся снизу вверх.
...
Таблица с конфигурацей оружия противников
...
Интенсивность оружия противников может иметь один и более временных слотов, в каждом отдельно задаётся минимальное и максимальное время фреймов и число повторов. Слот может быть паузой или активным сотоянием (стреляет).
...
Для разнообразия на каждом уровне может быть различное число противникой, каждый из которых обладает собственным набором оружия, имеет своё значение жизни, различную траекторию движения. противники могут быть обычные или боссами.

| Корабль противника           | Жизнь                    | Тип     | Алгоритм движения                               | Оружие                                                                                                                                                          |
| ----------------------- | ------------------------ | ------- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Конфигурация движения противника :
...
* Пемермещение, масштабирование, вращение
* Рисование спрайтов
