...
var Hexi = (function () {
  ...
  _createClass(Hexi, [{
    ...
    value: function text() {
      ...
      var font = arguments.length <= 1 || arguments[1] === undefined ? "sans" : arguments[1];
      var size = arguments.length <= 2 || arguments[2] === undefined ? "16px" : arguments[2];
      ...
      var message = this.spriteUtilities.text(content, font, size, fillStyle, x, y);
